...
while True:
        ...
        if id in up:
           ...
           if red_line_y<(cy+offset) and red_line_y > (cy-offset):
             ...
             if counter_up.count(id)==0:
                ...
                distance1 = 15# meters  (Distance between the 2 lines is 10 meters )
    ...
    cv2.line(frame, (172, 260), (774, 260), red_color, 2)
    cv2.putText(frame, ('Red Line'), (172, 260), cv2.FONT_HERSHEY_SIMPLEX, 0.5, text_color, 1, cv2.LINE_AA)

    cv2.line(frame, (8, 330), (927, 330), blue_color, 2)
    cv2.putText(frame, ('Blue Line'), (8, 330), cv2.FONT_HERSHEY_SIMPLEX, 0.5, text_color, 1, cv2.LINE_AA)
